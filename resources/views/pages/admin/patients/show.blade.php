                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <span class="text-muted">
                                            @if($patient->type_of_treatment && count($patient->type_of_treatment) > 0)
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <span class="text-muted">{{ $patient->height ? $patient->height . ' m' : 'N/A' }}</span>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="card" id="appointments-section">
                            ...
                            <!-- Filter Controls -->
                                    <div class="filter-section" style="margin: 0; border-radius: 0; border-bottom: 1px solid rgba(0,0,0,0.125);">
                                        <form method="GET" action="{{ route('admin.patients.show', $patient->id) }}#appointments-section">
                                            <div class="filter-row">
                                                <div class="filter-group">
                                                    <label class="form-label small text-muted mb-1">From Date</label>
                                                    <input type="text" class="form-control flatpickr-input" id="date_from" name="date_from" placeholder="From Date" value="{{ request('date_from') }}">
                                                </div>
                                                <div class="filter-group">
                                                    <label class="form-label small text-muted mb-1">To Date</label>
                                                    <input type="text" class="form-control flatpickr-input" id="date_to" name="date_to" placeholder="To Date" value="{{ request('date_to') }}">
                                                </div>
                                                <div class="filter-buttons">
                                                    ...
                                                    @if(request()->hasAny(['date_from', 'date_to']))
                                                        <a href="{{ route('admin.patients.show', $patient->id) }}#appointments-section" class="btn btn-outline-secondary btn-clear">
                                                        ...
                                                        <tr>
                                                            <th class="sortable-header" data-sort-column="date">
                                                                ...
                                                                <span class="sort-arrows">
                                                                    <span class="sort-arrow {{ (request('sort_by') == 'date' || request('sort_by') == 'visit_date_time') && request('sort_direction') == 'asc' ? 'active' : '' }}">▲</span>
                                                                    <span class="sort-arrow {{ (request('sort_by') == 'date' || request('sort_by') == 'visit_date_time') && request('sort_direction') == 'desc' ? 'active' : '' }}">▼</span>
                                                                </span>
                                                            </th>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1">
                                                                    @if($appointment->medicalRecords->count() > 0)
                                                                        @foreach($appointment->medicalRecords as $medicalRecord)
                                                                            <a href="{{ route('admin.patients.medical-record', [$patient->id, $medicalRecord->id]) }}" 
                                                                            ...
                                                                            <button type="button" 
                                                                                    ...
                                                                                    style="padding: 0.375rem 0.5rem;"
                                                                                    onclick="deleteMedicalRecord({{ $patient->id }}, {{ $medicalRecord->id }})">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    @if($primaryDoctorType === 'ophthalmologist')
                                                        <th>Diabetic Retinopathy (DR)</th>
                                                        <th>Diabetic Macular Edema (DME)</th>
                                                        <th>Type of DR</th>
                                                    @else
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="{{ $primaryDoctorType === 'ophthalmologist' ? '5' : '5' }}" class="text-center text-muted">No appointments found</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                ...
                function setupAjaxSorting() {
                    ...
                    sortableHeaders.forEach(function(header) {
                        header.addEventListener('click', function(e) {
                            ...
                            // Build URL
                            const ajaxUrl = '{{ route("admin.patients.show", $patient->id) }}?' + params.toString();
