        ...
        if ($snapshotTreatmentOther !== '') {
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <span
                                            class="badge {{ $patientMedicalRecord->appointment->patient_on_treatment_snapshot ? 'bg-success' : 'bg-danger' }}">
                                            {{ $patientMedicalRecord->appointment->patient_on_treatment_snapshot ? 'Yes' : 'No' }}
                                        </span>
                                    </div>
                                    <div class="col-md-3">
        ...
        if ($otherDisease !== '') {
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <span
                                            class="text-muted">{{ $patientMedicalRecord->appointment->patient_height_snapshot ? $patientMedicalRecord->appointment->patient_height_snapshot . ' m' : 'N/A' }}</span>
                                    </div>
                                    <div class="col-md-3">
