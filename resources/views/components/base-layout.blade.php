...
<head>
  ...
  .form-check-input.readonly{
    ...
    <script src="{{asset('plugins/jquery-ui/jquery.min.js')}}"></script>
    <script src="{{asset('js/alert-config.js')}}"></script>
    <script>
    ...
    @vite(['resources/scss/layouts/siteadmin/light/loader.scss'])

    @if (Request::is('siteadmin/*'))
        @vite(['resources/layouts/siteadmin/loader.js'])
...
>
    ...
    */
    ...
    @if (
        ...
        @if (Request::is('siteadmin/*'))
            @vite(['resources/layouts/siteadmin/app.js'])
        @elseif ((Request::is('modern-dark-menu/*')))
