                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="{{Vite::asset('resources/images/user-profile.jpeg')}}" class="img-fluid me-2" alt="avatar">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                ...
                                <img src="{{url(auth()->user()->profile_image)}}" alt="avatar" class="rounded-circle">
                                @else
                                <img src="{{$profilePath}}" alt="avatar" class="rounded-circle">
                                @endif
                            </div>
                        </div>
                    </a>
