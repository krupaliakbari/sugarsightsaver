            ...
            <div class="widget-content widget-content-area br-8">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <form method="POST" action="{{ route('doctor.patients.store-medical-entry', $appointment->id) }}" id="medicalEntryForm">
                            @csrf
                            ...
                            @if(Auth::user()->doctor_type === 'diabetes_treating')
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="type_of_diabetes" name="physician_record[type_of_diabetes]" style="margin-bottom: 10px;">
                                                    ...
                                                    <option value="type1" {{ old('physician_record.type_of_diabetes', $previousPhysicianRecord?->type_of_diabetes) == 'type1' ? 'selected' : '' }}>Type 1</option>
                                                    <option value="type2" {{ old('physician_record.type_of_diabetes', $previousPhysicianRecord?->type_of_diabetes) == 'type2' ? 'selected' : '' }}>Type 2</option>
                                                    <option value="other" {{ old('physician_record.type_of_diabetes', $previousPhysicianRecord?->type_of_diabetes) == 'other' ? 'selected' : '' }}>Other</option>
                                                </select>
                                                ...
                                                <div class="mt-2">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="physician_record[family_history_diabetes]" id="family_history_yes" value="1"
                                                               {{ old('physician_record.family_history_diabetes', $previousPhysicianRecord?->family_history_diabetes) == '1' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="physician_record[family_history_diabetes]" id="family_history_no" value="0"
                                                               {{ old('physician_record.family_history_diabetes', $previousPhysicianRecord?->family_history_diabetes) == '0' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="physician_record[current_treatment][]" id="lifestyle" value="lifestyle"
                                                                   {{ in_array('lifestyle', old('physician_record.current_treatment', $previousPhysicianRecord?->current_treatment ?? [])) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="physician_record[current_treatment][]" id="oha" value="oha"
                                                                   {{ in_array('oha', old('physician_record.current_treatment', $previousPhysicianRecord?->current_treatment ?? [])) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="physician_record[current_treatment][]" id="insulin" value="insulin"
                                                                   {{ in_array('insulin', old('physician_record.current_treatment', $previousPhysicianRecord?->current_treatment ?? [])) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="physician_record[current_treatment][]" id="glp1" value="glp1"
                                                                   {{ in_array('glp1', old('physician_record.current_treatment', $previousPhysicianRecord?->current_treatment ?? [])) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="physician_record[current_treatment][]" id="ayurvedic_homeopathy" value="ayurvedic_homeopathy"
                                                                   {{ in_array('ayurvedic_homeopathy', old('physician_record.current_treatment', $previousPhysicianRecord?->current_treatment ?? [])) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="physician_record[current_treatment][]" id="others_treatment" value="others"
                                                                   {{ in_array('others', old('physician_record.current_treatment', $previousPhysicianRecord?->current_treatment ?? [])) ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="others_treatment">Others</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mt-2" id="current_treatment_other_container" style="display: {{ in_array('others', old('physician_record.current_treatment', $previousPhysicianRecord?->current_treatment ?? [])) ? 'block' : 'none' }};">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="current_treatment_other" name="physician_record[current_treatment_other]"
                                                               value="{{ old('physician_record.current_treatment_other', $previousPhysicianRecord?->current_treatment_other ?? '') }}"
                                                ...
                                                <div class="mt-2">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="physician_record[compliance]" id="compliance_good" value="good"
                                                               {{ old('physician_record.compliance', $previousPhysicianRecord?->compliance) == 'good' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="physician_record[compliance]" id="compliance_irregular" value="irregular"
                                                               {{ old('physician_record.compliance', $previousPhysicianRecord?->compliance) == 'irregular' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="physician_record[compliance]" id="compliance_poor" value="poor"
                                                               {{ old('physician_record.compliance', $previousPhysicianRecord?->compliance) == 'poor' ? 'checked' : '' }}>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="blood_sugar_type" name="physician_record[blood_sugar_type]">
                                                    <option value="">Select Type</option>
                                                    <option value="rbs" {{ old('physician_record.blood_sugar_type', $previousPhysicianRecord?->blood_sugar_type) == 'rbs' ? 'selected' : '' }}>RBS</option>
                                                    <option value="fbs" {{ old('physician_record.blood_sugar_type', $previousPhysicianRecord?->blood_sugar_type) == 'fbs' ? 'selected' : '' }}>FBS</option>
                                                    <option value="ppbs" {{ old('physician_record.blood_sugar_type', $previousPhysicianRecord?->blood_sugar_type) == 'ppbs' ? 'selected' : '' }}>PPBS</option>
                                                    <option value="hba1c" {{ old('physician_record.blood_sugar_type', $previousPhysicianRecord?->blood_sugar_type) == 'hba1c' ? 'selected' : '' }}>HBA1C</option>
                                                </select>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" step="0.01" min="0" max="999.99" class="form-control" id="blood_sugar_value" name="physician_record[blood_sugar_value]"
                                                       value="{{ old('physician_record.blood_sugar_value', $previousPhysicianRecord?->blood_sugar_value) }}">
                                        ...
                                        <x-physician-medical-entry field-prefix="physician_record" :physician-record="$previousPhysicianRecord" />
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                ...
                                                <textarea class="form-control" id="other_data" name="physician_record[other_data]" rows="3"
                                                          placeholder="Enter any additional information">{{ old('physician_record.other_data', $previousPhysicianRecord?->other_data) }}</textarea>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.ucva_re', $previousOphthalmologistRecord?->ucva_re ?? '') }}"
                                                                ...
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.ucva_le', $previousOphthalmologistRecord?->ucva_le ?? '') }}"
                                                                        class="form-control shadow-none"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.bcva_re', $previousOphthalmologistRecord?->bcva_re ?? '') }}"
                                                                        class="form-control shadow-none"
                                                                        placeholder="Enter RE value">
                                                                </td>
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.bcva_le', $previousOphthalmologistRecord?->bcva_le ?? '') }}"
                                                                        class="form-control shadow-none"
                                                                        placeholder="Enter LE value">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.anterior_segment_re', $previousOphthalmologistRecord?->anterior_segment_re ?? '') }}"
                                                                        class="form-control shadow-none"
                                                                        placeholder="Enter RE value">
                                                                </td>
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.anterior_segment_le', $previousOphthalmologistRecord?->anterior_segment_le ?? '') }}"
                                                                        class="form-control shadow-none"
                                                                        placeholder="Enter LE value">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.iop_re', $previousOphthalmologistRecord?->iop_re ?? '') }}"
                                                                        class="form-control shadow-none"
                                                                        placeholder="Enter RE value">
                                                                </td>
                                                                <td style="border: none;">
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('ophthalmologist_record.iop_le', $previousOphthalmologistRecord?->iop_le ?? '') }}"
                                                                        class="form-control shadow-none"
                                                                        placeholder="Enter LE value">
                                                                </td>
                                                            </tr>
...
<div class="col-md-6">
    ...
    <div class="mt-2">
        ...
        <input type="radio" name="ophthalmologist_record[diabetic_retinopathy_re]" value="" style="display:none"
               {{ old('ophthalmologist_record.diabetic_retinopathy_re', $previousOphthalmologistRecord?->diabetic_retinopathy_re ?? '') === null || old('ophthalmologist_record.diabetic_retinopathy_re', $previousOphthalmologistRecord?->diabetic_retinopathy_re ?? '') === '' ? 'checked' : '' }}>

        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_retinopathy_re]" id="dr_yes_re" value="1"
                   {{ old('ophthalmologist_record.diabetic_retinopathy_re', $previousOphthalmologistRecord?->diabetic_retinopathy_re) == '1' ? 'checked' : '' }}>
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_retinopathy_re]" id="dr_no_re" value="0"
                   {{ old('ophthalmologist_record.diabetic_retinopathy_re', $previousOphthalmologistRecord?->diabetic_retinopathy_re) == '0' ? 'checked' : '' }}>
...
<div class="col-md-6">
    ...
    <div class="mt-2">
        ...
        <input type="radio" name="ophthalmologist_record[diabetic_retinopathy]" value="" style="display:none"
               {{ old('ophthalmologist_record.diabetic_retinopathy', $previousOphthalmologistRecord?->diabetic_retinopathy ?? '') === null || old('ophthalmologist_record.diabetic_retinopathy', $previousOphthalmologistRecord?->diabetic_retinopathy ?? '') === '' ? 'checked' : '' }}>

        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_retinopathy]" id="dr_yes" value="1"
                   {{ old('ophthalmologist_record.diabetic_retinopathy', $previousOphthalmologistRecord?->diabetic_retinopathy) == '1' ? 'checked' : '' }}>
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_retinopathy]" id="dr_no" value="0"
                   {{ old('ophthalmologist_record.diabetic_retinopathy', $previousOphthalmologistRecord?->diabetic_retinopathy) == '0' ? 'checked' : '' }}>
...
<div class="col-md-6">
    ...
    <div class="mt-2">
        ...
        <input type="radio" name="ophthalmologist_record[diabetic_macular_edema_re]" value="" style="display:none"
               {{ old('ophthalmologist_record.diabetic_macular_edema_re', $previousOphthalmologistRecord?->diabetic_macular_edema_re ?? '') === null || old('ophthalmologist_record.diabetic_macular_edema_re', $previousOphthalmologistRecord?->diabetic_macular_edema_re ?? '') === '' ? 'checked' : '' }}>

        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_macular_edema_re]" id="dme_yes_re" value="1"
                   {{ old('ophthalmologist_record.diabetic_macular_edema_re', $previousOphthalmologistRecord?->diabetic_macular_edema_re) == '1' ? 'checked' : '' }}>
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_macular_edema_re]" id="dme_no_re" value="0"
                   {{ old('ophthalmologist_record.diabetic_macular_edema_re', $previousOphthalmologistRecord?->diabetic_macular_edema_re) == '0' ? 'checked' : '' }}>
            <label class="form-check-label" for="dme_no_re">No</label>
        </div>
    </div>
    @error('ophthalmologist_record.diabetic_macular_edema_re')
        <div class="text-danger mt-1">{{ $message }}</div>
    @enderror
</div>
   ...
   <div class="col-md-6">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    <select class="form-select" id="type_of_dme_status_re" name="dme_status_re">
                                                        <option value="">Select Type</option>
                                                        <option value="nil_absent" {{ old('dme_status_re', in_array(old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme_re ?? ''), ['nil_absent']) ? 'nil_absent' : (in_array(old('ophthalmologist_record.type_of_dme_re', $previousOphthalmologistRecord?->type_of_dme_re ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'present' : '')) == 'nil_absent' ? 'selected' : '' }}>Nil/Absent</option>
                                                        <option value="present" {{ old('dme_status', in_array(old('ophthalmologist_record.type_of_dme_re', $previousOphthalmologistRecord?->type_of_dme_re ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'present' : '') == 'present' ? 'selected' : '' }}>Present</option>
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <!-- Sub-options for Present (shown conditionally) -->
                                                    <div id="dme_severity_container_re" style="display: {{ in_array(old('ophthalmologist_record.type_of_dme_re', $previousOphthalmologistRecord?->type_of_dme_re ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'block' : 'none' }};">
                                                        <select class="form-select" id="dme_severity_re" name="ophthalmologist_record[type_of_dme_re]">
                                                            <option value="">Select DME</option>
                                                            <option value="mild" {{ old('ophthalmologist_record.type_of_dme_re', $previousOphthalmologistRecord?->type_of_dme_re ?? '') == 'mild' ? 'selected' : '' }}>Mild</option>
                                                            <option value="moderate" {{ old('ophthalmologist_record.type_of_dme_re', $previousOphthalmologistRecord?->type_of_dme_re ?? '') == 'moderate' ? 'selected' : '' }}>Moderate</option>
                                                            <option value="severe" {{ old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme_re ?? '') == 'severe' ? 'selected' : '' }}>Severe (Based On Inv Of Fovea)</option>
                                                        </select>
                                                    </div>
                                                    <!-- Placeholder when severity container is hidden -->
                                                    <div id="dme_severity_placeholder_re" style="display: {{ in_array(old('ophthalmologist_record.type_of_dme_re', $previousOphthalmologistRecord?->type_of_dme_re ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'none' : 'block' }};">
                                            ...
                                            <input type="hidden" name="ophthalmologist_record[type_of_dme_re]" id="dme_hidden_nil_absent_re" value="nil_absent"
                                                   {{ old('ophthalmologist_record.type_of_dme_re', $previousOphthalmologistRecord?->type_of_dme ?? '') == 'nil_absent' ? '' : 'disabled' }}>
...
<div class="col-md-6">
    ...
    <div class="mt-2">
        ...
        <input type="radio" name="ophthalmologist_record[diabetic_macular_edema]" value="" style="display:none"
               {{ old('ophthalmologist_record.diabetic_macular_edema', $previousOphthalmologistRecord?->diabetic_macular_edema ?? '') === null || old('ophthalmologist_record.diabetic_macular_edema', $previousOphthalmologistRecord?->diabetic_macular_edema ?? '') === '' ? 'checked' : '' }}>

        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_macular_edema]" id="dme_yes" value="1"
                   {{ old('ophthalmologist_record.diabetic_macular_edema', $previousOphthalmologistRecord?->diabetic_macular_edema) == '1' ? 'checked' : '' }}>
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="ophthalmologist_record[diabetic_macular_edema]" id="dme_no" value="0"
                   {{ old('ophthalmologist_record.diabetic_macular_edema', $previousOphthalmologistRecord?->diabetic_macular_edema) == '0' ? 'checked' : '' }}>
...
<div class="col-md-6">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-6">
                                                    <select class="form-select" id="type_of_dme_status" name="dme_status">
                                                        <option value="">Select Type</option>
                                                        <option value="nil_absent" {{ old('dme_status', in_array(old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? ''), ['nil_absent']) ? 'nil_absent' : (in_array(old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'present' : '')) == 'nil_absent' ? 'selected' : '' }}>Nil/Absent</option>
                                                        <option value="present" {{ old('dme_status', in_array(old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'present' : '') == 'present' ? 'selected' : '' }}>Present</option>
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <!-- Sub-options for Present (shown conditionally) -->
                                                    <div id="dme_severity_container" style="display: {{ in_array(old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'block' : 'none' }};">
                                                        <select class="form-select" id="dme_severity" name="ophthalmologist_record[type_of_dme]">
                                                            <option value="">Select DME</option>
                                                            <option value="mild" {{ old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? '') == 'mild' ? 'selected' : '' }}>Mild</option>
                                                            <option value="moderate" {{ old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? '') == 'moderate' ? 'selected' : '' }}>Moderate</option>
                                                            <option value="severe" {{ old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? '') == 'severe' ? 'selected' : '' }}>Severe (Based On Inv Of Fovea)</option>
                                                        </select>
                                                    </div>
                                                    <!-- Placeholder when severity container is hidden -->
                                                    <div id="dme_severity_placeholder" style="display: {{ in_array(old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? ''), ['present', 'mild', 'moderate', 'severe']) ? 'none' : 'block' }};">
                                                        <select class="form-select" disabled>
                                                            <option>Select DME</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <input type="hidden" name="ophthalmologist_record[type_of_dme]" id="dme_hidden_nil_absent" value="nil_absent"
                                                   {{ old('ophthalmologist_record.type_of_dme', $previousOphthalmologistRecord?->type_of_dme ?? '') == 'nil_absent' ? '' : 'disabled' }}>
                                    ...
                                    <div class="row mb-3">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="ophthalmologist_record[investigations][]" id="fundus_pic" value="fundus_pic"
                                                               {{ in_array('fundus_pic', old('ophthalmologist_record.investigations', $previousOphthalmologistRecord?->investigations ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="ophthalmologist_record[investigations][]" id="oct" value="oct"
                                                               {{ in_array('oct', old('ophthalmologist_record.investigations', $previousOphthalmologistRecord?->investigations ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="ophthalmologist_record[investigations][]" id="octa" value="octa"
                                                               {{ in_array('octa', old('ophthalmologist_record.investigations', $previousOphthalmologistRecord?->investigations ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="ophthalmologist_record[investigations][]" id="ffa" value="ffa"
                                                               {{ in_array('ffa', old('ophthalmologist_record.investigations', $previousOphthalmologistRecord?->investigations ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="ophthalmologist_record[investigations][]" id="others_inv" value="others"
                                                               {{ in_array('others', old('ophthalmologist_record.investigations', $previousOphthalmologistRecord?->investigations ?? [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="others_inv">Others</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mt-2" id="investigations_others_container" style="display: {{ in_array('others', old('ophthalmologist_record.investigations', $previousOphthalmologistRecord?->investigations ?? [])) ? 'block' : 'none' }};">
                                                <div class="col-md-6">
                                                    <label for="investigations_others" class="form-label">Specify Other Investigations <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control @error('ophthalmologist_record.investigations_others') is-invalid @enderror" id="investigations_others" name="ophthalmologist_record[investigations_others]"
                                                           value="{{ old('ophthalmologist_record.investigations_others', $previousOphthalmologistRecord?->investigations_others ?? '') }}"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" id="advised_re" name="ophthalmologist_record[advised_re]">
                                                ...
                                                <option value="no_treatment" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'no_treatment' ? 'selected' : '' }}>No treatment</option>
                                                <option value="close_watch" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'close_watch' ? 'selected' : '' }}>Close watch</option>
                                                <option value="drops" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'drops' ? 'selected' : '' }}>Any other drops</option>
                                                <option value="medications" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'medications' ? 'selected' : '' }}>Medications</option>
                                                <option value="focal_laser" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'focal_laser' ? 'selected' : '' }}>Focal laser</option>
                                                <option value="prp_laser" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'prp_laser' ? 'selected' : '' }}>PRP laser</option>
                                                <option value="intravit_inj" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'intravit_inj' ? 'selected' : '' }}>Intravit inj antivefg</option>
                                                <option value="steroid" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'steroid' ? 'selected' : '' }}>Steroid</option>
                                                <option value="surgery" {{ old('ophthalmologist_record.advised_re', $previousOphthalmologistRecord?->advised_re) == 'surgery' ? 'selected' : '' }}>Surgery</option>
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" id="advised" name="ophthalmologist_record[advised]">
                                                <option value="">Select Treatment</option>
                                                <option value="no_treatment" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'no_treatment' ? 'selected' : '' }}>No treatment</option>
                                                <option value="close_watch" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'close_watch' ? 'selected' : '' }}>Close watch</option>
                                                <option value="drops" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'drops' ? 'selected' : '' }}>Any other drops</option>
                                                <option value="medications" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'medications' ? 'selected' : '' }}>Medications</option>
                                                <option value="focal_laser" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'focal_laser' ? 'selected' : '' }}>Focal laser</option>
                                                <option value="prp_laser" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'prp_laser' ? 'selected' : '' }}>PRP laser</option>
                                                <option value="intravit_inj" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'intravit_inj' ? 'selected' : '' }}>Intravit inj antivefg</option>
                                                <option value="steroid" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'steroid' ? 'selected' : '' }}>Steroid</option>
                                                <option value="surgery" {{ old('ophthalmologist_record.advised', $previousOphthalmologistRecord?->advised) == 'surgery' ? 'selected' : '' }}>Surgery</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control flatpickr-input" id="treatment_done_date" name="ophthalmologist_record[treatment_done_date]"
                                                   value="{{ old('ophthalmologist_record.treatment_done_date', $previousOphthalmologistRecord?->treatment_done_date) }}" placeholder="Select Treatment Date">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control flatpickr-input" id="review_date" name="ophthalmologist_record[review_date]"
                                                   value="{{ old('ophthalmologist_record.review_date', $previousOphthalmologistRecord?->review_date) }}" placeholder="Select Review Date">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="other_remarks" name="ophthalmologist_record[other_remarks]" rows="3"
                                                      placeholder="Enter any additional remarks...">{{ old('ophthalmologist_record.other_remarks', $previousOphthalmologistRecord?->other_remarks) }}</textarea>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('doctor.patients.index') }}" class="btn btn-light">Cancel</a>
    ...
    <x-slot:footerFiles>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const oldValue = typeEl.getAttribute('value') || typeEl.value || '{{ old('ophthalmologist_record.type_of_dr', $previousOphthalmologistRecord?->type_of_dr) }}';
              ...
              document.addEventListener('DOMContentLoaded', function() {
                ...
                // Initialize from old value
                const oldValue = typeEl.getAttribute('value') || typeEl.value || '{{ old('ophthalmologist_record.type_of_dr_re', $previousOphthalmologistRecord?->type_of_dr) }}';
                if (oldValue.startsWith('npdr')) {
                    categoryEl.value = 'npdr';
                    populateTypeOptions('npdr');
                    typeEl.value = oldValue;
