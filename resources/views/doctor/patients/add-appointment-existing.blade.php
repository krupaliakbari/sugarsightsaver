            ...
            <div class="widget-content widget-content-area br-8">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <form method="POST" action="{{ route('doctor.patients.store-appointment-existing-step1') }}" id="addAppointmentForm">
                            @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control flatpickr-input" id="visit_date_time" name="visit_date_time"
                                                       value="{{ old('visit_date_time', now()->format('d-m-Y H:i')) }}" placeholder="Select Appointment Date & Time">
                                        ...
                                        <div class="col-md-6" id="type_of_treatment_other_container" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="type_of_treatment_other" name="type_of_treatment_other"
                                                       value="{{ old('type_of_treatment_other', $patient->type_of_treatment_other) }}" placeholder="Enter other treatment type" autocomplete="off">
                                        ...
                                        <div class="col-md-12" id="other_diseases_other_container" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="other_diseases_other" name="other_diseases_other"
                                                       value="{{ old('other_diseases_other', $patient->other_diseases_other) }}" placeholder="Enter other disease" autocomplete="off">
            ...
            <div class="col-md-2">
                <div class="form-group mb-3">
                    ...
                    <small class="text-muted" id="height-hint">
                        {{ old('height_unit', $patient->height_unit) == 'feet' ? 'Maximum 9.0 feet' : 'Range: 0.5 – 3.0 meters' }}
                    </small>
                    @error('height')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
            ...
            <div class="col-md-2">
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" id="weight" name="weight"
                           value="{{ old('weight', $patient->weight) }}" step="0.01" min="10" max="500">
                    @error('weight')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
