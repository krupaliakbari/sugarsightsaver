            ...
            <div class="widget-content widget-content-area br-8">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <form method="POST" action="{{ route('doctor.patients.store-patient') }}" id="addPatientForm">
                            @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control flatpickr-input" id="visit_date_time" name="visit_date_time"
                                                       value="{{ old('visit_date_time', now()->format('d-m-Y H:i')) }}" placeholder="Select Date & Time">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="mobile_number" name="mobile_number"
                                                       value="{{ old('mobile_number', $mobileNumber) }}" pattern="[0-9]*" inputmode="numeric" maxlength="10">
                                                @error('mobile_number')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control flatpickr-input" id="diabetes_from" name="diabetes_from"
                                                       value="{{ old('diabetes_from') }}" placeholder="Select Month & Year">
                                                @error('diabetes_from')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control flatpickr-input" id="date_of_birth" name="date_of_birth"
                                                       value="{{ old('date_of_birth') }}" placeholder="Select Date of Birth">
                                                @error('date_of_birth')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" id="short_address" name="short_address" rows="2">{{ old('short_address') }}</textarea>
                                                @error('short_address')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
 ...
 <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="mt-2">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="on_treatment" id="on_treatment_yes" value="1" {{ old('on_treatment') == '1' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="on_treatment_yes">On Treatment</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="on_treatment" id="on_treatment_no" value="0" {{ old('on_treatment') == '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="mt-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="allopathic" value="allopathic" {{ in_array('allopathic', old('type_of_treatment', [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="allopathic">Allopathic</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="diet_control" value="diet_control" {{ in_array('diet_control', old('type_of_treatment', [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="diet_control">Diet Control</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="ayurvedic" value="ayurvedic" {{ in_array('ayurvedic', old('type_of_treatment', [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="ayurvedic">Ayurvedic</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="others_treatment" value="others" {{ in_array('others', old('type_of_treatment', [])) ? 'checked' : '' }}>
    ...
    <div class="col-md-6" id="type_of_treatment_container" style="display: none;">
        <div class="form-group mb-3">
            ...
            <div class="mt-2">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="allopathic"
                        value="allopathic" {{ in_array('allopathic', old('type_of_treatment', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="allopathic">Allopathic</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="diet_control"
                        value="diet_control" {{ in_array('diet_control', old('type_of_treatment', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="diet_control">Diet Control</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="ayurvedic"
                        value="ayurvedic" {{ in_array('ayurvedic', old('type_of_treatment', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="ayurvedic">Ayurvedic</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="type_of_treatment[]" id="others_treatment"
                        value="others" {{ in_array('others', old('type_of_treatment', [])) ? 'checked' : '' }}>
                    <label class="form-check-label" for="others_treatment">Others</label>
                </div>
            </div>
            @error('type_of_treatment')
            ...
            @enderror
                                        ...
                                        <div class="col-md-6" id="type_of_treatment_other_container" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="type_of_treatment_other" name="type_of_treatment_other"
                                                       value="{{ old('type_of_treatment_other') }}" placeholder="Enter other treatment type">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="mt-2">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="bp" id="bp_yes" value="1" {{ old('bp') == '1' ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="bp_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="bp" id="bp_no" value="0" {{ old('bp') == '0' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6" id="bp_since_container" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control flatpickr-input" id="bp_since" name="bp_since"
                                                       value="{{ old('bp_since') }}" placeholder="Select Month & Year">
                                                @error('bp_since')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="mt-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="other_diseases[]" id="heart_disease" value="heart_disease" {{ in_array('heart_disease', old('other_diseases', [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="heart_disease">Heart Disease</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="other_diseases[]" id="cholesterol" value="cholesterol" {{ in_array('cholesterol', old('other_diseases', [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="cholesterol">Cholesterol</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="other_diseases[]" id="thyroid" value="thyroid" {{ in_array('thyroid', old('other_diseases', [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="thyroid">Thyroid</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="other_diseases[]" id="stroke" value="stroke" {{ in_array('stroke', old('other_diseases', [])) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="stroke">Stroke</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="other_diseases[]" id="others_diseases" value="others" {{ in_array('others', old('other_diseases', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-12" id="other_diseases_other_container" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="other_diseases_other" name="other_diseases_other"
                                                       value="{{ old('other_diseases_other') }}" placeholder="Enter other disease">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" id="other_input" name="other_input" rows="2">{{ old('other_input') }}</textarea>
                                                @error('other_input')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
    ...
    <div class="form-group mb-3">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="height_unit" id="unit_meter" value="meter" 
                   {{ old('height_unit', 'meter') == 'meter' ? 'checked' : '' }}>
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="height_unit" id="unit_feet" value="feet"
                   {{ old('height_unit', 'meter') == 'feet' ? 'checked' : '' }}>
...
<div class="col-md-2">
    <div class="form-group mb-3">
        <label for="height" class="form-label">
            Height
            <span id="height-unit-display">(in {{ old('height_unit', 'meter') == 'feet' ? 'Feet' : 'Meters' }})</span>
        </label>
        <input type="number"
               class="form-control"
               id="height"
               ...
               value="{{ old('height') }}"
               step="0.01"
               placeholder="{{ old('height_unit', 'meter') == 'feet' ? 'e.g., 5.9' : 'e.g., 1.75' }}"
               min="{{ old('height_unit', 'meter') == 'feet' ? '2.0' : '0.5' }}"
               max="{{ old('height_unit', 'meter') == 'feet' ? '9.0' : '3.0' }}">
        <small class="text-muted" id="height-hint">
            {{ old('height_unit', 'meter') == 'feet' ? 'Range: 2.0 – 9.0 feet' : 'Range: 0.5 – 3.0 meters' }}
        </small>
        @error('height')
            <div class="text-danger">{{ $message }}</div>
        @enderror
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control" id="weight" name="weight"
                                                       value="{{ old('weight') }}" step="0.01" min="10" max="500">
                                                @error('weight')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('doctor.patients.add-appointment') }}" class="btn btn-light">Cancel</a>
