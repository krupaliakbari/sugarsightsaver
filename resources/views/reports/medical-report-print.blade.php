        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <span class="text-muted">{{ $appointment->patient_mobile_number_snapshot ?? $patient->mobile_number }}</span>
                </div>
                <div class="col-md-3">
                    <strong>SSSP ID</strong>
                    <span class="badge bg-info">{{ $appointment->patient_sssp_id_snapshot ?? $patient->sssp_id }}</span>
                </div>
                <div class="col-md-3">
                    <strong>Email</strong>
                    <span class="text-muted">{{ $appointment->patient_email_snapshot ?? $patient->email ?? 'N/A' }}</span>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <span class="text-muted">{{ ($appointment->patient_diabetes_from_snapshot ?? $patient->diabetes_from) ? ($appointment->patient_diabetes_from_snapshot ?? $patient->diabetes_from)->format('M Y') : 'N/A' }}</span>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <span class="text-muted">{{ ($appointment->patient_date_of_birth_snapshot ?? $patient->date_of_birth) ? ($appointment->patient_date_of_birth_snapshot ?? $patient->date_of_birth)->format('M d, Y') : 'N/A' }}</span>
                </div>
                <div class="col-md-3">
                    <strong>Age</strong>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    <strong>Sex</strong>
                    <span class="badge bg-secondary">{{ ucfirst($appointment->patient_sex_snapshot ?? $patient->sex) }}</span>
                </div>
                <div class="col-md-3">
                    <strong>Hospital ID</strong>
                    <span class="text-muted">{{ $appointment->patient_hospital_id_snapshot ?? $patient->hospital_id ?? 'N/A' }}</span>
                </div>
                <div class="col-md-6">
                    <strong>Short Address</strong>
                    <span class="text-muted">{{ $appointment->patient_short_address_snapshot ?? $patient->short_address }}</span>
                </div>
            </div>
                 @php
// On Treatment
...
@endphp
                ...
                {{-- <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <span class="badge {{ ($appointment->patient_on_treatment_snapshot ?? $patient->on_treatment) ? 'bg-success' : 'bg-danger' }}">
                            {{ ($appointment->patient_on_treatment_snapshot ?? $patient->on_treatment) ? 'Yes' : 'No' }}
                        </span>
                    </div> --}}
                    <div class="row mb-3">
    ...
    <div class="col-md-3">
        ...
        <span class="text-muted">
            @if($showOtherTreatment)
                {{ $treatmentOtherValue ?: 'Not specified' }}
            @else
                Not applicable
            @endif
        </span>
    ...
    <div class="col-md-3"></div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <span class="text-muted">{{ $appointment->patient_other_input_snapshot ?? $patient->other_input ?? 'N/A' }}</span>
                </div>
                <div class="col-md-3"></div>
                <div class="col-md-3"></div>
                @else
    ...
    <span class="text-muted">
        ...
        @endif
                ...
                <div class="col-md-3">
                    ...
                    <span class="text-muted">{{ ($appointment->patient_weight_snapshot ?? $patient->weight) ? ($appointment->patient_weight_snapshot ?? $patient->weight) . ' kg' : 'N/A' }}</span>
                </div>
                   <div class="col-md-3">
    <strong>BMI</strong>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <span class="badge {{ $physicianRecord->family_history_diabetes ? 'bg-success' : 'bg-danger' }}">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <span class="badge {{ $ophthalmologistRecord->diabetic_retinopathy_re ? 'bg-success' : 'bg-danger' }}">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <span class="badge {{ $ophthalmologistRecord->diabetic_macular_edema_re ? 'bg-success' : 'bg-danger' }}">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <span class="text-muted">{{ $ophthalmologistRecord->treatment_done_date ? $ophthalmologistRecord->treatment_done_date->format('M d, Y') : 'Not specified' }}</span>
                                            </div>
                                            <div class="col-md-3">
                                                <strong>Review Date</strong>
                                                <span class="text-muted">{{ $ophthalmologistRecord->review_date ? $ophthalmologistRecord->review_date->format('M d, Y') : 'Not specified' }}</span>
                                            </div>
                                            @endif
