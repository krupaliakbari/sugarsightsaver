                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                 ...
                                 <!-- Specify Other Treatment Row - For "Type of Treatment" (Basic Profile Details) -->
                                <?php
                                    ...
                                    // Only show if "others" is in the treatment array AND there's a value
if (
    $appointment &&
        ...
        if ($snapshotTreatmentOther !== '') {
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <span
                                            class="badge <?php echo e($patientMedicalRecord->appointment->patient_on_treatment_snapshot ? 'bg-success' : 'bg-danger'); ?>">
                                            <?php echo e($patientMedicalRecord->appointment->patient_on_treatment_snapshot ? 'Yes' : 'No'); ?>
        ...
        if ($otherDisease !== '') {
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <span
                                            class="text-muted"><?php echo e($patientMedicalRecord->appointment->patient_height_snapshot ? $patientMedicalRecord->appointment->patient_height_snapshot . ' m' : 'N/A'); ?></span>
                                    </div>
                                    <div class="col-md-3">
...
<?php endif; ?>
<?php /**PATH C:\Users\ANZO-KRUPALI\Desktop\sugarsightsaver1\resources\views/pages/admin/patients/medical-record.blade.php ENDPATH**/ ?>