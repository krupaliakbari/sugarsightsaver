...
">Add Appointment</h4>
                            <?php if(request()->has('from')): ?>
                                ...
                                <a href="<?php echo e($backRoute); ?>" class="btn btn-outline-secondary">
                                    <i class="fas fa-arrow-left me-2"></i><?php echo e($backText); ?>
    ...
    <!--  BEGIN CUSTOM SCRIPTS FILE  -->
     <?php $__env->slot('footerFiles', null, []); ?> 
        ...
        $('#searchPatientForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("doctor.patients.search")); ?>',
                type: 'POST',
                data: {
        ...
        $('#addNewPatientBtn').on('click', function() {
            const mobileNumber = $('#mobile_number').val().trim();
            window.location.href = '<?php echo e(route("doctor.patients.add-patient")); ?>?mobile_number=' + encodeURIComponent(mobileNumber);
        });
    });
            ...
            function displaySearchResults(patients, mobileNumber) {
                ...
                patients.forEach(function(patient) {
                    ...
                    html += '<td>';
                    html += '<a href="<?php echo e(route("doctor.patients.add-appointment-existing")); ?>?patient_id=' + patient.id + '" class="btn btn-sm btn-primary me-2">';
...
<?php endif; ?>
<?php /**PATH C:\Users\ANZO-KRUPALI\Desktop\sugarsightsaver1\resources\views/doctor/patients/add-appointment.blade.php ENDPATH**/ ?>