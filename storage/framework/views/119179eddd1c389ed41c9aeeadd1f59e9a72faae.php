...
@media (max-width: 576px) {
    ...
    justify-content: end;">
        <a href="<?php echo e(route('doctor.patients.add-appointment-existing')); ?>?patient_id=<?php echo e($patient->id); ?>"
           class="btn btn-primary flex-fill flex-md-grow-0">
            <i class="fas fa-plus me-2"></i>Add New Appointment
        </a>

        <a href="<?php echo e(route('doctor.patients.edit', $patient->id )); ?>"
    ...
    <div class="col-md-3">
        ...
        <span class="text-muted">
            <?php if($patient->on_treatment && $patient->type_of_treatment && count($patient->type_of_treatment) > 0): ?>
    ...
    <?php if($patient->on_treatment && $showSpecifyOther && $otherTreatment !== ''): ?>
    <div class="col-md-3">
    ...
    <form method="GET" action="<?php echo e(route('doctor.patients.medical-records', $patient->id)); ?>#appointments-section">
        <div class="filter-row">
            <div class="filter-group">
                <label class="form-label small text-muted mb-1">Date</label>
                <input type="text" class="form-control flatpickr-input" id="appointment_date" name="appointment_date" 
                       placeholder="Select Date" 
                      value="<?php echo e(request('appointment_date')); ?>">
            ...
            <div class="filter-buttons">
                <button type="submit" class="btn btn-primary btn-filter">
                 ...
                 <?php if(request()->hasAny(['appointment_date'])): ?>
                    <a href="<?php echo e(route('doctor.patients.medical-records', $patient->id)); ?>#appointments-section" class="btn btn-outline-secondary btn-clear">
                                                        ...
                                                        <tr></tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1">
                                                                    <a href="<?php echo e(route('doctor.patients.appointments.edit', $appointment->id)); ?>"
                                                                    ...
                                                                    <?php if($appointment->medicalRecords->count() > 0): ?>
                                                                        ...
                                                                        ?>
                                                                        <a href="<?php echo e(route('doctor.medical.summary', $firstMedicalRecord->id)); ?>"
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-1">
                                                                    ...
                                                                    <!-- <button type="button"
                                                                            ...
                                                                            style="padding: 0.375rem 0.5rem;"
                                                                            onclick="confirmDeleteAppointment(<?php echo e($appointment->id); ?>)">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="<?php echo e(Auth::user()->doctor_type === 'ophthalmologist' ? '5' : '5'); ?>" class="text-center text-muted">No appointments found</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                ...
                function setupAjaxSorting() {
                    ...
                    sortableHeaders.forEach(function(header) {
                        header.addEventListener('click', function(e) {
                            ...
                            // Build URL
                            const ajaxUrl = '<?php echo e(route("doctor.patients.medical-records", $patient->id)); ?>?' + params.toString();
            ...
            function confirmDeleteAppointment(appointmentId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = '<?php echo e(route("doctor.patients.appointments.delete", ":id")); ?>'.replace(':id', appointmentId);
...
<?php endif; ?>
<?php /**PATH C:\Users\ANZO-KRUPALI\Desktop\sugarsightsaver1\resources\views/doctor/patients/medical-records.blade.php ENDPATH**/ ?>