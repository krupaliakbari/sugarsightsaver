    ...
    <div class="row mt-3">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="widget-content widget-content-area br-8">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <h4 class="mb-4">Edit Patient - <?php echo e($patient->name); ?></h4>
                        ...
                        <!-- Patient Edit Form -->
                        <form method="POST" action="<?php echo e(route('doctor.patients.update', $patient->id)); ?>" id="editPatientForm">
                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-md-6" id="type_of_treatment_other_container" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="type_of_treatment_other" name="type_of_treatment_other"
                                                       value="<?php echo e(old('type_of_treatment_other', $patient->type_of_treatment_other)); ?>" placeholder="Enter other treatment type">
                                        ...
                                        <div class="col-md-12" id="other_diseases_other_container" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="other_diseases_other" name="other_diseases_other"
                                                       value="<?php echo e(old('other_diseases_other', $patient->other_diseases_other)); ?>" placeholder="Enter other disease">
            ...
            <div class="col-md-2">
                <div class="form-group mb-3">
                    ...
                    <small class="text-muted" id="height-hint">
                        <?php echo e(old('height_unit', $patient->height_unit) == 'feet' ? 'Range: 2.0 – 9.0 feet' : 'Range: 0.5 – 3.0 meters'); ?>
            ...
            <div class="col-md-2">
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" id="weight" name="weight"
                           value="<?php echo e(old('weight', $patient->weight)); ?>" step="0.01" min="1" max="500">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="">
                        <input type="text" class="form-control" id="bmi" name="bmi"
                               value="<?php echo e(old('bmi', $patient->bmi)); ?>" readonly style="max-width: 100px; margin-bottom: 10px;">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="d-flex justify-content-end">
                                        <a href="<?php echo e(route('doctor.patients.index')); ?>" class="btn btn-light me-3">Cancel</a>
...
<?php endif; ?>
<?php /**PATH /home4/wethew2a/sugarsightsaver.in/resources/views/doctor/patients/edit.blade.php ENDPATH**/ ?>