        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <span
                        class="text-muted"><?php echo e($appointment->patient_mobile_number_snapshot ?? $patient->mobile_number); ?></span>
                </div>
                <div class="col-md-3">
                    <strong>SSSP ID</strong>
                    <span
                        class="badge bg-info"><?php echo e($appointment->patient_sssp_id_snapshot ?? $patient->sssp_id); ?></span>
                </div>
                <div class="col-md-3">
                    <strong>Email</strong>
                    <span
                        class="text-muted"><?php echo e($appointment->patient_email_snapshot ?? ($patient->email ?? 'N/A')); ?></span>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <span
                        class="text-muted"><?php echo e($appointment->patient_diabetes_from_snapshot ?? $patient->diabetes_from ? ($appointment->patient_diabetes_from_snapshot ?? $patient->diabetes_from)->format('M Y') : 'N/A'); ?></span>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <span
                        class="text-muted"><?php echo e($appointment->patient_date_of_birth_snapshot ?? $patient->date_of_birth ? ($appointment->patient_date_of_birth_snapshot ?? $patient->date_of_birth)->format('M d, Y') : 'N/A'); ?></span>
                </div>
                <div class="col-md-3">
                    <strong>Age</strong>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    <strong>Sex</strong>
                    <span
                        class="badge bg-secondary"><?php echo e(ucfirst($appointment->patient_sex_snapshot ?? $patient->sex)); ?></span>
                </div>
                <div class="col-md-3">
                    <strong>Hospital ID</strong>
                    <span
                        class="text-muted"><?php echo e($appointment->patient_hospital_id_snapshot ?? ($patient->hospital_id ?? 'N/A')); ?></span>
                </div>
                <div class="col-md-6">
                    <strong>Short Address</strong>
                    <span
                        class="text-muted"><?php echo e($appointment->patient_short_address_snapshot ?? $patient->short_address); ?></span>
                </div>
            </div>
...
<div class="row mb-3">
    ...
    <div class="col-md-3">
        ...
        <span class="text-muted">
            <?php if($onTreatment && !empty($typeTreatment)): ?>
    ...
    <div class="col-md-3">
        ...
        <span class="text-muted">
            <?php echo e($onTreatment && $showOtherTreatment ? ($treatmentOtherValue ?: 'Not specified') : 'Not applicable'); ?>
    ...
    <div class="col-md-3">
        <?php if($diseases && in_array('others', $diseases)): ?>
            ...
            <span class="text-muted">
                ...
                ?>
                <?php echo e(!empty($otherDisease) ? trim($otherDisease) : 'N/A'); ?>
    ...
    <div class="col-md-3">
        ...
        <span class="text-muted">
            <?php echo e($appointment->patient_other_input_snapshot ?? ($patient->other_input ?? 'N/A')); ?>
...
?>
    ...
    <span class="text-muted">
        <?php if($appointment->patient_height_snapshot ?? $patient->height): ?>
            <?php echo e($appointment->patient_height_snapshot ?? $patient->height); ?> 
        ...
        <?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <span
                        class="text-muted"><?php echo e($appointment->patient_weight_snapshot ?? $patient->weight ? ($appointment->patient_weight_snapshot ?? $patient->weight) . ' kg' : 'N/A'); ?></span>
                </div>
             <div class="col-md-3">
    <strong>BMI</strong>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <span
                            class="badge <?php echo e($physicianRecord->family_history_diabetes ? 'bg-success' : 'bg-danger'); ?>">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <span
                            class="badge <?php echo e($ophthalmologistRecord->diabetic_retinopathy_re ? 'bg-success' : 'bg-danger'); ?>">
                    ...
                    <div class="col-md-3">
                        ...
                        <span
                            class="badge <?php echo e($ophthalmologistRecord->diabetic_retinopathy ? 'bg-success' : 'bg-danger'); ?>">
                    ...
                    <div class="col-md-3">
                        ...
                        <span
                            class="badge <?php echo e($ophthalmologistRecord->diabetic_macular_edema_re ? 'bg-success' : 'bg-danger'); ?>">
                    ...
                    <div class="col-md-3">
                        ...
                        <span
                            class="badge <?php echo e($ophthalmologistRecord->diabetic_macular_edema ? 'bg-success' : 'bg-danger'); ?>">
                ...
                <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <span
                                class="text-muted"><?php echo e($ophthalmologistRecord->treatment_done_date ? $ophthalmologistRecord->treatment_done_date->format('M d, Y') : 'Not specified'); ?></span>
                        </div>
                        <div class="col-md-3">
                            <strong>Review Date</strong>
                            <span
                                class="text-muted"><?php echo e($ophthalmologistRecord->review_date ? $ophthalmologistRecord->review_date->format('M d, Y') : 'Not specified'); ?></span>
                        </div>
                        <?php endif; ?>
...
<?php /**PATH C:\Users\ANZO-KRUPALI\Desktop\sugarsightsaver1\resources\views/reports/medical-report.blade.php ENDPATH**/ ?>