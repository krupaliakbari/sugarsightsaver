    ...
    <?php if(
        ...
        <?php if(!Request::routeIs('blank')): ?>
            ...
            <?php if(Request::is('siteadmin/*')): ?>
                ...
                <!--  BEGIN NAVBAR  -->
                <?php if (isset($component)) { $__componentOriginal70c024f9f7ff3d2c98e9e506eb297ee74ee6a59b = $component; } ?>
<?php $component = App\View\Components\Navbar\StyleVerticalMenu::resolve(['classes' => ''.e(($isBoxed ? 'container-xxl' : '')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('navbar.style-vertical-menu'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Navbar\StyleVerticalMenu::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal70c024f9f7ff3d2c98e9e506eb297ee74ee6a59b)): ?>
<?php $component = $__componentOriginal70c024f9f7ff3d2c98e9e506eb297ee74ee6a59b; ?>
<?php unset($__componentOriginal70c024f9f7ff3d2c98e9e506eb297ee74ee6a59b); ?>
<?php endif; ?>
                <!--  END NAVBAR  -->
...
<?php endif; ?>
            ...
            <?php elseif(Request::is('horizontal-light-menu/*')): ?>
                ...
                <!--  BEGIN NAVBAR  -->
                <?php if (isset($component)) { $__componentOriginal08b150d04d13e906e0720bbd9736b0e68898cd25 = $component; } ?>
<?php $component = App\View\Components\Navbar\StyleHorizontalMenu::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('navbar.style-horizontal-menu'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Navbar\StyleHorizontalMenu::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal08b150d04d13e906e0720bbd9736b0e68898cd25)): ?>
<?php $component = $__componentOriginal08b150d04d13e906e0720bbd9736b0e68898cd25; ?>
<?php unset($__componentOriginal08b150d04d13e906e0720bbd9736b0e68898cd25); ?>
<?php endif; ?>
                <!--  END NAVBAR  -->
...
<?php endif; ?>
            ...
            <?php if(!Request::routeIs('blank')): ?> 
                ...
                <?php if(Request::is('siteadmin/*')): ?>
                    ...
                    <!--  BEGIN SIDEBAR  -->
                    <?php if (isset($component)) { $__componentOriginala23a9f7b295b775708fa52de9abf53c922f9a8bf = $component; } ?>
<?php $component = App\View\Components\Menu\VerticalMenu::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('menu.vertical-menu'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Menu\VerticalMenu::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala23a9f7b295b775708fa52de9abf53c922f9a8bf)): ?>
<?php $component = $__componentOriginala23a9f7b295b775708fa52de9abf53c922f9a8bf; ?>
<?php unset($__componentOriginala23a9f7b295b775708fa52de9abf53c922f9a8bf); ?>
<?php endif; ?>
                    <!--  END SIDEBAR  --> 
...
<?php endif; ?>
                ...
                <?php elseif(Request::is('horizontal-light-menu/*')): ?>
                    ...
                    <!--  BEGIN SIDEBAR  -->
                    <?php if (isset($component)) { $__componentOriginal054a50b5d083a251b5154d2acc496ff2cefc4063 = $component; } ?>
<?php $component = App\View\Components\Menu\HorizontalMenu::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('menu.horizontal-menu'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Menu\HorizontalMenu::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal054a50b5d083a251b5154d2acc496ff2cefc4063)): ?>
<?php $component = $__componentOriginal054a50b5d083a251b5154d2acc496ff2cefc4063; ?>
<?php unset($__componentOriginal054a50b5d083a251b5154d2acc496ff2cefc4063); ?>
<?php endif; ?>
                    <!--  END SIDEBAR  --> 
...
</html><?php /**PATH C:\Users\ANZO-KRUPALI\Desktop\sugarsightsaver1\resources\views/components/base-layout.blade.php ENDPATH**/ ?>