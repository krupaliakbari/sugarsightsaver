...
">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <button type="button" class="btn btn-secondary" onclick="sendWhatsAppMsg()">
    ...
    .then(data => {
        ...
        if (data.status === true) {
            Swal.fire("Success", "Appointment summary has been sent successfully on WhatsApp.", "success");
        } else {
